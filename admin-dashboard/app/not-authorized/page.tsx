  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-bg p-6">
      <div className="w-full max-w-md rounded-lg border border-border bg-surface p-8 text-center shadow-card">
        ...
        <h1 className="text-2xl font-bold tracking-tight text-text">Not authorized</h1>
        <p className="mt-2 text-sm text-muted">
          The admin dashboard is restricted to operators with the <span className="font-semibold text-text">ADMIN</span> role.
        </p>
